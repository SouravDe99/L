    ...
    if player == 'r':
        if index in explored_blue.keys():
            if explored_blue[index] is None:
                ...
                if index in second_appearances['blue_negative']:
                    explored_blue[index] = -1
                if index in second_appearances['blue_zero']:
    ...
    if player == 'b':
        if index in explored_red.keys():
            if explored_red[index] is None:
                ...
                if index in second_appearances['red_negative']:
                    explored_red[index] = -1
                if index in second_appearances['red_zero']:
...
counter = 0
print("Value: ", minimax(1686, -1, 1, 0, 'r'))
